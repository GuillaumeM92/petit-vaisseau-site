...
const VERSION = '3fe45b2'; // replaced by the deploy script, so a new version replaces the old cache
...
const ShellFiles = [
  ...
  'audio-worklet.js', 'engine/composer.js', 'engine/freeverb.js', 'engine/instruments.js', 'engine/mixer.js',
